...
Just download the installer [here](https://github.com/d-falck/MicroAuth/releases/download/v1.2/MicroAuth_1.2_Installer.dmg).
...
- Improve countdown bar (change to circle?)
